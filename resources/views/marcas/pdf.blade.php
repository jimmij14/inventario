...
<body>
    ...
    <header>
        ...
        <div class="titulo">
            ...
            <div class="reporte">Sistema de Inventario &mdash; Reporte de Marcas</div>
        </div>
    </header>
    ...
    <div class="contenido">
        ...
        <div class="subtitulo">Total de registros: {{ $marcas->count() }}</div>
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" style="text-align:center; padding: 15px;">No hay marcas registradas</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

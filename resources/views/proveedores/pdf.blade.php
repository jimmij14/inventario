...
<body>
    ...
    <header>
        ...
        <div class="titulo">
            ...
            <div class="reporte">Sistema de Inventario &mdash; Reporte de Proveedores</div>
        </div>
    </header>
    ...
    <div class="contenido">
        ...
        <div class="subtitulo">Total de registros: {{ $proveedores->count() }}</div>
        ...
        <table>
            ...
            <tbody>
                @forelse($proveedores as $key => $proveedor)
                    <tr>
                ...
                @empty
                    <tr>
                        <td colspan="8" style="text-align:center; padding: 15px;">No hay proveedores registrados</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

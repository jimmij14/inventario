...
<body>
    ...
    <header>
        ...
        <div class="titulo">
            ...
            <div class="reporte">Sistema de Inventario &mdash; Reporte de Modelos</div>
        </div>
    </header>
    ...
    <div class="contenido">
        ...
        <div class="subtitulo">Total de registros: {{ $modelos->count() }}</div>
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" style="text-align:center; padding: 15px;">No hay modelos registrados</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

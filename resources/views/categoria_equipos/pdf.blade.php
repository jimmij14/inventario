...
<head>
    <meta charset="utf-8">
    <title>Listado de Categorías de Equipo</title>
    <style>
        @page {
...
<body>
    ...
    <header>
        ...
        <div class="titulo">
            ...
            <div class="reporte">Sistema de Inventario &mdash; Reporte de Categorías de Equipo</div>
        </div>
    </header>
    ...
    <div class="contenido">
        <h2>Listado de Categorías de Equipo</h2>
        <div class="subtitulo">Total de registros: {{ $categoriaEquipos->count() }}</div>
        ...
        <table>
            ...
            <tbody>
                @forelse($categoriaEquipos as $key => $catEq)
                    <tr>
                ...
                @empty
                    <tr>
                        <td colspan="4" style="text-align:center; padding: 15px;">No hay categorías de equipo registradas</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

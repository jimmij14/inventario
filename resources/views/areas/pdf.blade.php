...
<body>
    ...
    <header>
        ...
        <div class="titulo">
            ...
            <div class="reporte">Sistema de Inventario &mdash; Reporte de Áreas</div>
        </div>
    </header>
    ...
    <div class="contenido">
        ...
        <div class="subtitulo">Total de registros: {{ $areas->count() }}</div>
            ...
            <tbody>
                @forelse($areas as $key => $area)
                    <tr>
                        ...
                        <td>{{ $area->responsable->dni ?? '—' }} - {{ $area->responsable->nombre_completo ?? '' }}</td>
                        <td>{{ $area->descripcion ?: '—' }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="5" style="text-align:center; padding: 15px;">No hay áreas registradas</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

                ...
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        <a class="nav-link dropdown-toggle mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{ asset('Admin/images/flags/us.jpg') }}" alt="user-image" class="mr-2" height="12"> <span class="align-middle">English <i class="mdi mdi-chevron-down"></i> </span>
                        </a>
...
<!-- Left Sidebar End -->
                                                ...
                                                <ul class="conversation-list slimscroll" style="min-height: 330px;">
                                                    <li class="clearfix">
                                                        <div class="chat-avatar">
                                                            <img src="{{ asset('Admin/images/users/avatar-2.jpg') }}" alt="male">
                                                            <i>10:00</i>
                                                        </div>
                                                    ...
                                                    <li class="clearfix odd">
                                                        <div class="chat-avatar">
                                                            <img src="{{ asset('Admin/images/users/avatar-3.jpg') }}" alt="Female">
                                                            <i>10:01</i>
                                                        </div>
                                                        <div class="conversation-text">
                                                            <div class="ctext-wrap">
                                                    ...
                                                    <li class="clearfix odd">
                                                        <div class="chat-avatar">
                                                            <img src="{{ asset('Admin/images/users/avatar-3.jpg') }}" alt="male">
                                                            <i>10:02</i>
                                                        </div>
                                                        <div class="conversation-text">
                                                            <div class="ctext-wrap">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group list-group-lg">
                                                <li class="list-group-item border-0 pt-2">
                                                    <a href="" class=" mr-3">
                                                        <img src="{{ asset('Admin/images/users/avatar-3.jpg') }}" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="{{ asset('Admin/images/users/avatar-4.jpg') }}" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="{{ asset('Admin/images/users/avatar-5.jpg') }}" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="{{ asset('Admin/images/users/avatar-6.jpg') }}" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="{{ asset('Admin/images/users/avatar-7.jpg') }}" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                ...
                                                <li class="list-group-item border-0">
                                                    <a href="" class=" mr-3">
                                                        <img src="{{ asset('Admin/images/users/avatar-8.jpg') }}" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                    <span class="float-right badge badge-info mt-2">Webdesigner</span>
                                                ...
                                                <li class="list-group-item border-0 pb-1">
                                                    <a href="" class=" mr-3">
                                                        <img src="{{ asset('Admin/images/users/avatar-9.jpg') }}" alt="user-img" class="avatar-sm rounded">
                                                    </a>
                                                    <span class="float-right badge badge-warning mt-2">Webdeveloper</span>
                                                    <a href="">John Deo</a>
                                                </li>
        ...
        <div class="right-bar">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="p-4">
                    ...
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input theme-choice" id="dark-mode-switch" data-bsstyle="Admin/css/bootstrap-dark.min.css" data-appstyle="Admin/css/app-dark.min.css">
                    ...
                    <div class="custom-control custom-switch mb-5">
                        <input type="checkbox" class="custom-control-input theme-choice" id="rtl-mode-switch" data-appstyle="Admin/css/app-rtl.min.css">
        ...
        <script src="{{ asset('Admin/libs/jquery-scrollto/jquery.scrollTo.min.js') }}"></script>
        <script src="{{ asset('Admin/libs/sweetalert2/sweetalert2.min.js') }}"></script>

        <!-- Chat app -->
        <script src="{{ asset('Admin/js/pages/jquery.chat.js') }}"></script>

        <!-- Todo app -->
        <script src="{{ asset('Admin/js/pages/jquery.todo.js') }}"></script>

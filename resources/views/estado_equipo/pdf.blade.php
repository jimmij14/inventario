...
<head>
    <meta charset="utf-8">
    <title>Listado de Estados de Equipo</title>
    <style>
        @page {
...
<body>
    ...
    <header>
        ...
        <div class="titulo">
            ...
            <div class="reporte">Sistema de Inventario &mdash; Reporte de Estados de Equipo</div>
        </div>
    </header>
    ...
    <div class="contenido">
        <h2>Listado de Estados de Equipo</h2>
        <div class="subtitulo">Total de registros: {{ $estados->count() }}</div>
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" style="text-align:center; padding: 15px;">No hay estados de equipo registrados</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

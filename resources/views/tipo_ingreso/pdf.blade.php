...
<body>
    ...
    <header>
        ...
        <div class="titulo">
            ...
            <div class="reporte">Sistema de Inventario &mdash; Reporte de Tipos de Ingreso</div>
        </div>
    </header>
    ...
    <div class="contenido">
        <h2>Listado de Tipos de Ingreso</h2>
        <div class="subtitulo">Total de registros: {{ $tipos->count() }}</div>
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" style="text-align:center; padding: 15px;">No hay tipos de ingreso registrados</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

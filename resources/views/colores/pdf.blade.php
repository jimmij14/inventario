...
<body>
    ...
    <header>
        ...
        <div class="titulo">
            ...
            <div class="reporte">Sistema de Inventario &mdash; Reporte de Colores</div>
        </div>
    </header>
    ...
    <div class="contenido">
        ...
        <div class="subtitulo">Total de registros: {{ $colores->count() }}</div>
        ...
        <table>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" style="text-align:center; padding: 15px;">No hay colores registrados</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
